        ...
        <>   
            ...
            <section className='py-2'>
                ...
                <h3>No hassle, get your meal without leaving your home</h3>
                    ...
                    <div className="tab-content border-top py-4" id="pills-tabContent">
                        ...
                        <div className="tab-pane fade" id="pills-dessert" role="tabpanel" aria-labelledby="pills-dessert-tab">
                            <div className="container">
                                <div className="row g-4">
                                    {card}
                                    {card}
                        ...
                        <div className="tab-pane fade" id="pills-salad" role="tabpanel" aria-labelledby="pills-salad-tab">
                            <div className="container">
                                <div className="row g-4">
                                    {card}
                                    {card}
                        ...
                        <div className="tab-pane fade" id="pills-continential" role="tabpanel" aria-labelledby="pills-continential-tab">
                            <div className="container">
                                <div className="row g-4">
                                    {card}
                                    {card}
